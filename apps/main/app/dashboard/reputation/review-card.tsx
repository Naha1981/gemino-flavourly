  ...
  return (
    <div className="mt-3 rounded-md border border-zinc-800 bg-zinc-950/60 p-3">
      <div className="mb-2 flex items-center gap-2 text-[11px] uppercase tracking-wide text-zinc-500">
        ...
        Response draft {isSent && <span className="text-zinc-600">(already sent — editing disabled)</span>}
      </div>
      <textarea
        value={draft}
        ...
        className="w-full rounded-md border border-zinc-800 bg-zinc-900 p-2 text-sm text-zinc-200 outline-none focus:border-emerald-600 disabled:opacity-60"
      />
        ...
        {!isSent && (
          <>
            <button
              ...
              className="flex items-center gap-1.5 rounded-md border border-zinc-700 bg-zinc-900 px-3 py-1.5 text-xs text-zinc-200 hover:bg-zinc-800 disabled:opacity-50"
            >
