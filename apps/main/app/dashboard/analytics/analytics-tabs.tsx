...
function KpiCard({ summary }: { summary: EngineSummary }) {
  ...
  return (
    <div className="rounded-lg border border-zinc-800 bg-zinc-900/60 p-4">
      ...
      <p className="mt-2 text-2xl font-semibold text-zinc-50">{summary.total30.toLocaleString()}</p>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            ...
            <div className="rounded-lg border border-zinc-800 bg-zinc-900/60 p-4">
              ...
              <p className="mt-2 text-2xl font-semibold text-zinc-50">{forecast.slope.toFixed(1)}</p>
              <p className="mt-3 text-[11px] text-zinc-500">cents/day (linear regression)</p>
            </div>
          </div>
        </div>
      )}
