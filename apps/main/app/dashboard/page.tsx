  ...
  return (
    <div className="space-y-8 max-w-5xl">
      ...
      {!waAccount?.isConnected && (
        <div className="rounded-lg border border-amber-900/60 bg-amber-950/30 p-5 shadow-sm">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <h3 className="font-semibold text-amber-300">Action Required: WhatsApp Not Connected</h3>
              <p className="text-sm text-zinc-400 mt-0.5">Your WhatsApp line is offline. Connect it to start answering customer inquiries automatically.</p>
            </div>
            <Link 
              href="/dashboard/whatsapp" 
              className="inline-flex items-center justify-center gap-2 rounded-md bg-amber-500 px-4 py-2.5 text-sm font-semibold text-zinc-950 hover:bg-amber-400 transition-colors shadow-sm"
            >
